            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#tareas" data-toggle="tab">Tareas</a></li>

                  <li class="nav-item"><a class="nav-link" href="#problemas" data-toggle="tab">Problemas</a></li>
              ...
              <div class="card-header">
                 ...
                 <div class="card-tools">
                  ...
                  <div class="input-group input-group-sm" style="width: 180px;">
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#agregarAct">
                      Nueva Actividad
                    </button>
                  </div>
                </div>
            ...
            <div class="card">
              <div class="card-header">
                 ...
                 <div class="card-tools">
                  ...
                  <div class="input-group input-group-sm" style="width: 180px;">
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#agregarTarea">
                      Nueva Tarea
                    </button>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <label>Seleccionar actividad</label>
                        <select class="form-control">
                          <option>Crear base de datos</option>
                          <option>Crear modulo de pagos</option>
                        </select>
                  </div>
            ...
            <div class="card">
              <div class="card-header">
                 ...
                 <div class="card-tools">
                  ...
                  <div class="input-group input-group-sm" style="width: 180px;">
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#agregarProblema">
                      Nuevo Problema
                    </button>
                  </div>
                </div>
